...
//         console.log("Decode token response:", JSON.stringify(res.data, null, 2));

//         if (res.status === 200 && res.data.res) {
//           const userData = res.data.res;
//           setUser(userData);

//           // Log the entire user data to see structure
//           console.log("User data:", JSON.stringify(userData, null, 2));

//           // Check for account status - this is the critical field from your data
//           if (userData.accountstatus) {
//             setAccountStatus(userData.accountstatus);
//             console.log("Account status detected:", userData.accountstatus);
//           }

//           // Also check other possible status fields
//           if (userData.status) {
//             setUserStatus(userData.status);
//           }

//           // Check if user is banned - look at accountstatus field
...
//           console.log("Is banned check:", {
//             accountstatus: userData.accountstatus,
//             isBanned,
//             bannedStatuses
//           });

//           // If banned, immediately redirect
//           if (isBanned) {
...
//           // Fetch KYC status using user email (only if not banned)
//           if (userData.email) {
//             try {
//               console.log("Fetching KYC for email:", userData.email);
//               const kycRes = await axios.get(
//                 `https://auth.vizit.homes/api/kyc/user/${userData.email}`
//               );

//               console.log("KYC response:", JSON.stringify(kycRes.data, null, 2));

//               if (kycRes.data && kycRes.data.kyc) {
//                 setKycStatus(kycRes.data.kyc.status);
//               } else {
//                 setKycStatus(null); // No KYC found
//               }
//             } catch (kycErr) {
...
//     // Run every 19 seconds to refresh
...
//     // Check if user account is banned using accountstatus
//     const bannedStatuses = ["suspended", "deactivated", "blocked", "ban"];

//     // Use accountstatus as the primary field for ban status
...
//     // BANNED USERS - Redirect to banned screen and prevent all access
//     if (user && accountStatus && isBanned) {
//       if (currentRoute !== "banned") {
//         console.log(`Account ${accountStatus}, redirecting to banned screen`);
//         router.replace("/banned");
//       }
//       return; // Stop further checks for banned users
//     }

//     // KYC protection (only for non-banned users)
//     if (user) {
//       // If KYC is not approved and user tries to access protected routes (except KYC itself)
...
//       // If user tries to access KYC route but is already approved, redirect to home
...
//       router.replace("/Login");
//     }
//   }, [user, accountStatus, userStatus, kycStatus, isChecking, loading, segments]);
...
//           {
//             !user && <Pressable style={styles.item} onPress={() => navigate("/Login")}>
...
//           <Pressable onPress={openSidebar} disabled={isBanned}>
//             <MaterialCommunityIcons
//               name="menu"
//               size={26}
//               color={isBanned ? "#666" : "#000000ff"}
//             />
//           </Pressable>
//           <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
//             <FontAwesome5 name="home" size={24} color={isBanned ? "#666" : "black"} />
//             <Text style={[styles.headerTitle, isBanned && { color: "#666" }]}>
//               VIZIT.HOMES
//             </Text>
//           </View>
//           {!user ? (
...
//               onPress={() => !isBanned && router.push("/modal")}
//               disabled={isBanned}
//             >
//               <Image
...
//                 </View>
//               )}
//               {/* KYC Status Indicator (only if not banned) */}
//               {!isBanned && (
//                 <>
//                   {kycStatus === "approved" && (
...
//             display: isBanned ? "none" : user && kycStatus !== "approved" ? "none" : "flex",
//           },
//         }}
//       >
//         <Tabs.Screen
...
//             tabBarIcon: ({ color }) => (
//               <MaterialCommunityIcons name="home-city" size={26} color={color} />
//             ),
//           }}
//         />
...
//             href: isBanned ? null : undefined,
//             tabBarIcon: ({ color }) => (
//               <AntDesign name="schedule" size={24} color={color} />
//             ),
//           }}
//         />
