...
// const propertyTypes = [
//     { value: "Apartment", icon: "business-outline", family: "Ionicons" },
//     { value: "Guest House", icon: "home-outline", family: "Ionicons" },
//     { value: "Hotel", icon: "bed-outline", family: "Ionicons" },
//     { value: "Modern Room", icon: "cube-outline", family: "Ionicons" },
//     { value: "Studio", icon: "color-palette-outline", family: "Ionicons" },
//     { value: "Villa", icon: "golf-outline", family: "Ionicons" },
//     { value: "Penthouse", icon: "chevron-up-circle-outline", family: "Ionicons" },
//     { value: "Townhouse", icon: "layers-outline", family: "Ionicons" }
// ];
...
// function UpdatePropertyScreenContent() {
...
//                 const response = await axios.get(`${API_BASE}/houses/${id}`);
//                 const house = response.data.house;

//                 // Extract location data
//                 const address = house.location?.address || "";
//                 const coordinates = house.location?.coordinates || { lat: 0, lng: 0 };

//                 // Format media
//                 const mediaItems = house.reviews?.images?.map(url => ({
//                     url,
//                     type: "image"
//                 })) || [];
...
//                 setIsAvailable(house.isAvalable !== undefined ? house.isAvalable : true);
//             } catch (error) {
...
//                 Alert.alert(
//                     "Location Required",
//                     "We need your location to set the property address automatically.",
//                     [
...
//             if (!result.canceled) {
//                 const uploads = await handleImageUpload([result.assets[0]]);
//                 setFormData(prev => ({
//                     ...prev,
//                     media: [...prev.media, ...uploads]
//                 }));
...
//         const uploads = await handleImageUpload(files);
//         setFormData(prev => ({
//             ...prev,
//             media: [...prev.media, ...uploads]
//         }));
...
//             <Text style={styles.sectionSubtitle}>Update your property details</Text>
...
//             <Text style={styles.sectionSubtitle}>Update your space details</Text>
...
//             <Text style={styles.sectionSubtitle}>Update property amenities</Text>
...
//             <Text style={styles.sectionSubtitle}>Update property media</Text>
...
//             <Text style={styles.sectionSubtitle}>Review changes before updating</Text>
...
//                         <Text style={styles.availabilityLabel}>Property Status</Text>
...
//                                 style={[
//                                     styles.toggleOption,
//                                     !isAvailable && styles.toggleOptionInactive
//                                 ]}
...
//                     I confirm that the information is accurate and I have the right to update this listing
//                 </Text>
//             </View>
//         </View>
//     );
...
//                         <Ionicons name="arrow-back" size={24} color="#10ca8c" />
//                     </TouchableOpacity>
//                     <View style={{ backgroundColor: "#fff" }}>
//                         <Text style={styles.headerTitle}>Update Listing</Text>
//                         <Text style={styles.headerSubtitle}>Edit property details</Text>
//                     </View>
//                     <TouchableOpacity
...
//                                 {activeStep === 4 ? "Update Listing" : "Continue"}
//                             </Text>
...
//     },
//     selectButtonActive: {
//         backgroundColor: 'rgba(16, 202, 140, 0.1)',
//         borderColor: '#10ca8c',
//     },
//     selectText: {
//         color: '#999',
...
function UpdatePropertyScreenContent() {
    ...
    const [dragOver, setDragOver] = useState(false);
    const [isAvailable, setIsAvailable] = useState(true);
    const [existingHouseData, setExistingHouseData] = useState<any>(null);
    ...
    const handleSubmit = async () => {
        ...
        try {
            // Preserve existing reviews data
            const existingReviews = existingHouseData?.reviews || {
                overallRating: 0,
                totalReviews: 0,
                canEdit: true,
                entries: []
            ...
            const payload = {
                ...
                isAvalable: isAvailable,
                image: formData.media[0]?.url || "",
                // Preserve all existing review data, only update images
                reviews: {
                    ...existingReviews,
                    images: formData.media.map(m => m.url),
                },
